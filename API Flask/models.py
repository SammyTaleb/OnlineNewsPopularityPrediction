...
#Building Models
best_params_rf={'bootstrap': True, 'max_depth': 30, 'max_features': 'sqrt', 'min_samples_leaf': 4, 'min_samples_split': 5, 'n_estimators': 500}
clf_rf=RandomForestClassifier(**best_params_rf)
clf_rf.fit(train_X,train_Y_bool)

best_params_gb={'learning_rate': 0.1, 'max_depth': 21, 'max_features': 'sqrt', 'min_samples_leaf': 4, 'min_samples_split': 5, 'n_estimators': 500}
clf_gb=GradientBoostingClassifier(**best_params_gb)
clf_gb.fit(train_X,train_Y_bool)



pickle.dump(clf_rf, open('clf_rf.pkl','wb'))
pickle.dump(clf_gb, open('clf_gb.pkl','wb'))